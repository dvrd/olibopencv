...
// Wrapper for an individual cv::RotatedRect<float>
...
void Mat_InRangeWithScalar(Mat src, const Scalar lowerb, const Scalar upperb,
                           Mat dst);
...
double KMeansPoints(PointVector pts, int k, Mat bestLabels,
