...
foreign cv {
	...
	videocapture_open :: proc(capture: VideoCapture, device_id, api_id: c.int) -> c.bool ---
	videocapture_release :: proc(capture: VideoCapture) ---
	videocapture_isopened :: proc(capture: VideoCapture) -> c.bool ---
	videocapture_read :: proc(capture: VideoCapture, frame: Mat) -> c.bool ---
}
